...
func NewMessage(body, user_name string) (*Message, error) {
	id, err := newMessageId()
	...
	return &Message{
		Id:   id,
		Body: body,
		CreatedAt: created_at,// 1-1. CreatedAt に時刻をセットする	// ヒント: https://golang.org/pkg/time/
		Username: user_name,//user_names,// 1-2. Username にユーザ名をセットする
	}, nil
}
